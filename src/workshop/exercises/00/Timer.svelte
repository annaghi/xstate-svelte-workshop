<script>
  ...
  // Import the timer machine which is implemented as a custom store:
  // import { ... } from './timerMachine.js';

  const timerMachine = ''; // delete me - use the imported store instead!
...
>
  <header><h1>Exercise 00</h1></header>
  <ProgressCircle />
